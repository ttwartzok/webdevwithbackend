...
<?php session_start(); ?>
<head>
    <title>Griswald's Car For Sale</title>
...
<div class="productContainer">
    <div class="row">
        <div class="column">
            <img src="/images/griswalds.jpg" class= "productImage">
            <h2 style="font-weight: normal">Wagon Queen Family Truckster</h2>
            <h1>$95, 000</h1>
            <p>863,524 miles</p>
