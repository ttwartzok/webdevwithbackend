...
<head>
    <title>Jetsons Car For Sale</title>
...
<div class="productContainer">
    <div class="row">
        <div class="column">
            <img src="/images/jetsons.jpg" class= "productImage">
            <h2 style="font-weight: normal">Jetsons Car</h2>
            <h1>$1, 500, 000</h1>
            <p>674,968 miles</p>
            ...
            <p class="info">Try a test drive to feel what it is like to own your very own Jetsons car!<br><br>
                <span id="dots">For more details, fill out the Contact Seller section, or read more!</span><span id="more"> This isn't a real car but was inspired by a 1954 Ford concept car: FX-Atmos, which you can probably find somewhere on the internet. The information listed below is completely fictional; it is all made it up so that I was able to see how text would look in the container as well as if my Read More button worked.
        </span></p>
