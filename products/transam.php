...
<head>
    <title>77 Trans Am For Sale</title>
...
<div class="productContainer">
    <div class="row">
        <div class="column">
            <img src="/images/77transam.jpg" class= "productImage">
            <h2 style="font-weight: normal">77 Trans Am</h2>
            <h1>$85, 000</h1>
            <p>603,923 miles</p>
            ...
            <p class="info">Try a test drive to feel what it is like to own your very own 77 Trans Am car!<br><br>
                <span id="dots">For more details, fill out the Contact Seller section, or read more!</span><span id="more"> This car is real! You can probably find it somewhere on the internet. The information listed below is completely fictional; it is all made it up so that I was able to see how text would look in the container as well as if my Read More button worked.
        </span></p>
